...
public class TumblrApi extends DefaultApi10a
{
  ...
  private static final String X_AUTH_ACCESS_TOKEN_RESOURCE = "https://www.tumblr.com/oauth/access_token";
  ...
  @Override
  public String getXAuthAccessTokenEndpoint() {
    return X_AUTH_ACCESS_TOKEN_RESOURCE;
  }
}
