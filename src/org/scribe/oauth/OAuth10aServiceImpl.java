...
public class OAuth10aServiceImpl implements OAuthService
{
  ...
  public Token getXAuthAccessToken(String username, String password)
  {
    config.log("obtaining xAuth Access token from " + api.getAccessTokenEndpoint());
    OAuthRequest request = new OAuthRequest(api.getAccessTokenVerb(), api.getXAuthAccessTokenEndpoint());
    
    request.addBodyParameter("x_auth_username", username);
